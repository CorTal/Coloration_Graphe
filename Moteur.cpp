...
void Moteur::setGraph(Graphe gr)
{
  Graph = gr;
}
...
string Moteur::DSATUR_m()
{
  ...
  G.set_nb_colors(nb_color);
  edges = Graph.get_edges();
  oss << "Algorithme DSATUR : " << endl << "Graphe colorié avec : " << nb_color << " couleurs" << endl;
  for (unsigned int i=0; i<edges.size(); ++i)
    oss << *edges[i] << endl;
  return oss.str();
}

string Moteur::Glouton_degre_m()
{
  ostringstream oss;
  int nb_color = 0;
  int color;
  ...
  G.set_nb_colors(nb_color);
  edges = Graph.get_edges();
  oss << "Algorithme Glouton trié selon l'arité des noeuds : " << endl << "Graphe colorié avec : " << nb_color << " couleurs" << endl;
  for (unsigned int i=0; i<edges.size(); ++i)
    oss << *edges[i] << endl;
  return oss.str();
}

string Moteur::Glouton_largeur_m()
{
  ostringstream oss;
  int nb_color=0, color;
  Graphe G(Graph);
  ...
  G.set_nb_colors(nb_color);
  edges = Graph.get_edges();
  oss << "Algorithme Glouton avec parcours en largeur : " << endl << "Graphe colorié avec : " << nb_color << " couleurs" << endl;
  for (unsigned int i=0; i<edges.size(); ++i)
    oss << *edges[i] << endl;
  return oss.str();
}

string Moteur::Glouton_m()
{
  ostringstream oss;
  int nb_color = 0;
  int color;
  ...
  G.set_nb_colors(nb_color);
  oss << "Algorithme Glouton simple : " << endl << "Graphe colorié avec : " << nb_color << " couleurs" << endl;
  for (unsigned int i=0; i<edges.size(); ++i)
    oss << *edges[i] << endl;
  return oss.str();
}

string Moteur::Glouton_profondeur_m()
{
  ostringstream oss;
  int nb_color=0, color;
  Graphe G(Graph);
  ...
  G.set_nb_colors(nb_color);
  edges = Graph.get_edges();
  oss << "Algorithme Glouton avec parcours en profondeur : " << endl << "Graphe colorié avec : " << nb_color << " couleurs" << endl;
  for (unsigned int i=0; i<edges.size(); ++i)
    oss << *edges[i] << endl;
  return oss.str();
}
...
string Moteur::NoN_m()
{
  ...
  G.set_nb_colors(color);
  edges = Graph.get_edges();
  oss << "Algorithme Non : " << endl << "Graphe colorié avec : " << color << " couleurs" << endl;
  for (unsigned int i=0; i<edges.size(); ++i)
    oss << *edges[i] << endl;
  return oss.str();
}

string Moteur::Welsh_Powell_m()
{
  ostringstream oss;
   int color=0;
  Noeud* v, *v_test;
  ...
  G.set_nb_colors(color);
  edges = Graph.get_edges();
  oss << "Algorithme Welsh et Powell : " << endl << "Graphe colorié avec : " << color << " couleurs" << endl;
  for (unsigned int i=0; i<edges.size(); ++i)
    oss << *edges[i] << endl;
  return oss.str();
}
